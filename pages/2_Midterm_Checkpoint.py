...
st.write('After running LSTM on our dataset, we achieved a very high accuracy. In the classification report below, class 0 represents a “No Flood” prediction and class 1 represents a “Flood” prediction. As can be seen, the model predicted these events with 97&percnt; and 99&percnt; accuracy, respectively.')
